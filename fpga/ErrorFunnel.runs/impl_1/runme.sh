...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ErrorFunnel_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ErrorFunnel_Top.tcl -notrace
