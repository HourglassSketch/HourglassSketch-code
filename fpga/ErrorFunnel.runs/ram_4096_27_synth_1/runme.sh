...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/ram_4096_27_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4096_27.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_4096_27.tcl
