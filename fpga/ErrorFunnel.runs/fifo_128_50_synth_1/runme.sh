...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/fifo_128_50_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_128_50.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_128_50.tcl
