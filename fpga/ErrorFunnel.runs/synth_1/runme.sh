...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ErrorFunnel_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ErrorFunnel_Top.tcl
