...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/ram_16384_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_16384_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_16384_2.tcl
