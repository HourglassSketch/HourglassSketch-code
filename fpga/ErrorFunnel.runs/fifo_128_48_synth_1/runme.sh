...
HD_PWD='D:/SourceCode/Xilinx/ErrorFunnel/ErrorFunnel.runs/fifo_128_48_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_128_48.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_128_48.tcl
