...
public class TransactionImpl implements InternalTransaction
{
    ...
    public WCSketch WBSketch;
    public HourglassSketch HourglassSketch;
                            ...
                            TransactionExceptionMapper exceptionMapper )
    {
        ...
        this.HourglassSketch = new HourglassSketch(10000);
    ...
    public void commit()
    {
        ...
        File file = new File(WBSketch.filePath);
        WBSketch.SaveToFile(file, WBSketch);
    }
    ...
    public Iterator<Relationship> getRelationships(int srcNodeID, int dstNodeID){
        org.neo4j.graphdb.WCSketch.WBRelation wcRelation = HourglassSketch.query_edge(srcNodeID, dstNodeID);
        return new WCIterator(wcRelation, WBSketch);
    }
    
    public int getRelationships111(int srcNodeID){
        int wcRelation = HourglassSketch.query_vertex_start(srcNodeID);
        return 0;
    }

    public class WCIterator implements ResourceIterator<Relationship>
    {
        public ArrayList<Integer> array;//所有relID
        public int pos;//pos-1是当前wcrecord在array中的位置
        public int num;//relID的数量

        public WCIterator(org.neo4j.graphdb.WCSketch.WBRelation target, WCSketch sketch)
        {
