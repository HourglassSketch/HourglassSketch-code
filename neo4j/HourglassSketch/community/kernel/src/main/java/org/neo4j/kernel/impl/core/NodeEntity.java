...
import org.neo4j.graphdb.HourglassSketch;
...
public class NodeEntity implements Node, RelationshipFactory<Relationship>
{
    ...
    public Relationship createRelationshipTo( Node otherNode, RelationshipType type )
    {
        ...
        try
        {
            ...
            // ti.WBSketch.insert((Integer) getProperty("NodeID"), (Integer)otherNode.getProperty("NodeID"), WBSketch.buildWCRecord((int)relationshipId));
            ti.HourglassSketch.insert((Integer) getProperty("NodeID"), (Integer)otherNode.getProperty("NodeID"), 1);
